...
public class Enam extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        imageAngka.setImageResource(R.drawable.enam);
        ...
        text1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(Enam.this,R.raw.e);
                mp.start();
            }
        });
        ...
        text2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(Enam.this,R.raw.n);
                mp.start();
            }
        });
        ...
        text3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(Enam.this,R.raw.a);
                mp.start();
            }
        });
        ...
        text4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MediaPlayer mp = MediaPlayer.create(Enam.this,R.raw.m);
                mp.start();
            }
        });
        ...
        playNama.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
                setSupportActionBar(toolbar);
                getSupportActionBar().setTitle("ENAM");

                MediaPlayer mp = MediaPlayer.create(Enam.this,R.raw.aenam);
                mp.start();
        ...
        playNamaE.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
                setSupportActionBar(toolbar);
                getSupportActionBar().setTitle("SIX");

                MediaPlayer mp = MediaPlayer.create(Enam.this,R.raw.eenam);
                mp.start();
                ...
                text1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        MediaPlayer mp = MediaPlayer.create(Enam.this,R.raw.ss);
                        mp.start();
                    }
                });
                ...
                text2.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        MediaPlayer mp = MediaPlayer.create(Enam.this,R.raw.ii);
                        mp.start();
                    }
                });
                ...
                text3.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        MediaPlayer mp = MediaPlayer.create(Enam.this,R.raw.xx);
                        mp.start();
                    }
                });
